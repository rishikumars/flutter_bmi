            ...
            new Container(
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  style: TextStyle(color: Colors.blue,fontSize: 22.0,fontWeight: FontWeight.w700,fontStyle: FontStyle.italic),),
                  new Text("$health",
                    style: TextStyle(color: Colors.pinkAccent,fontSize: 22.0,fontWeight: FontWeight.w700,fontStyle: FontStyle.italic),),
